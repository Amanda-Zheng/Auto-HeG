...
def edge_info(dataset, args):
    ...
    torch.save(hop_edge_index, './tree_info/hop_edge_index_' + args.data + '_' + str(args.tree_layer))
    torch.save(hop_edge_att, './tree_info/hop_edge_att_' + args.data + '_' + str(args.tree_layer))
