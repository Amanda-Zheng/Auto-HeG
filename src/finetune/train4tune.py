...
from src.utils_lib import gen_uniform_60_20_20_split, mixhop_edge_info
...
def train_trans(data, model, criterion, optimizer):
    ...
    prec1, prec5 = src.utils.accuracy(input, target, topk=(1, 3))
    n = input.size(0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='cornell', help='location of the data corpus {cora,cornell,squirrel,wisconsin,texas,film}')
